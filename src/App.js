...
function App() {
  const InitialWstlrList = [
    ...
    },
    {
      ...
      age: "44",
      about:
        "John Felix Anthony Cena (/ˈsiːnə/ SEE-nə; born April 23, 1977) is an American professional wrestler, actor, and former rapper, currently signed to WWE. ... He gained fame in the WWE after adopting the persona of a trash-talking rapper. He won his first singles title, the United States Championship, in 2004.",
    },
    {
